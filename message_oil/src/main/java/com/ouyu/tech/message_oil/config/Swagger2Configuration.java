package com.ouyu.tech.message_oil.config;
...
public class Swagger2Configuration {
   //api接口包扫描路径
   public static final String SWAGGER_SCAN_BASE_PACKAGE = "com.ouyu.tech.message_oil";
    ...
    */
    ...
    private ApiInfo apiInfo() {
       return new ApiInfoBuilder()
                   .title("团油消息服务") //设置文档的标题
                   .description("团油消息服务 API 接口文档") // 设置文档的描述
